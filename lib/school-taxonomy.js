...
// 根据 tier/schoolPropertyLabel 推断 category
export function inferSchoolCategory(school) {
  ...
  if (tier === '市重点' || schoolPropertyLabel === '市重点') return 'shi-zhongdian';
  if (tier === '市特色普通高中' || schoolPropertyLabel.includes('市特色')) return 'shi-tese';
  if (tier === '区重点' || schoolPropertyLabel === '区重点') return 'qu-zhongdian';
