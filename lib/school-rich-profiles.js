...
const CORE_SCHOOL_PROFILES = {
  ...
  'huangpu-上海市格致中学': {
    ...
    scoreLines: [
      { year: '2025', batch: '1-15 志愿统一招生', score: '680.5', scope: '黄浦 / 八大', source: SCORE_SOURCE_2025 },
      { year: '2024', batch: '1-15 志愿统一招生', score: '678', scope: '黄浦 / 八大', source: SCORE_SOURCE_2024 }
    ],
    sources: [
  ...
  'huangpu-上海市大同中学': {
    ...
    scoreLines: [
      { year: '2025', batch: '1-15 志愿统一招生', score: '682', scope: '黄浦 / 八大', source: SCORE_SOURCE_2025 },
      { year: '2024', batch: '1-15 志愿统一招生', score: '679', scope: '黄浦 / 八大', source: SCORE_SOURCE_2024 }
    ],
    sources: [
  ...
  'yangpu-上海市控江中学': {
    ...
    scoreLines: [
      { year: '2025', batch: '1-15 志愿统一招生', score: '690', scope: '杨浦 / 八大', source: SCORE_SOURCE_2025 },
      { year: '2024', batch: '1-15 志愿统一招生', score: '687', scope: '杨浦 / 八大', source: SCORE_SOURCE_2024 }
    ],
    sources: [
  ...
  'changning-上海市长宁区延安中学': {
    ...
    scoreLines: [
      { year: '2025', batch: '1-15 志愿统一招生', score: '682.5', scope: '长宁 / 八大', source: SCORE_SOURCE_2025 },
      { year: '2024', batch: '1-15 志愿统一招生', score: '680', scope: '长宁 / 八大', source: SCORE_SOURCE_2024 }
    ],
    sources: [
  ...
  'hongkou-上海市复兴高级中学': {
    ...
    scoreLines: [
      { year: '2025', batch: '1-15 志愿统一招生', score: '680', scope: '虹口 / 八大', source: SCORE_SOURCE_2025 },
      { year: '2024', batch: '1-15 志愿统一招生', score: '677', scope: '虹口 / 八大', source: SCORE_SOURCE_2024 }
    ],
    sources: [
