...
function newsUrls(region, baseWithRegion, ids) {
  // 地区专属新闻专题页来自配置（regions.data.json 的 home.newsSpecialPages），
  // 第三地区未建专题前为空数组，sitemap 不再误收上海专题路径。
  const specialPages = getRegionConfig(region).home?.newsSpecialPages || [];
