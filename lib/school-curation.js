import { getSchoolOverview } from './school-content.js';

const SCHOOL_SYSTEM_DEFINITIONS = [
...
const TRAINING_DIRECTION_DEFINITIONS = [
...
export function inferTrainingDirections(school) {
  ...
  if (!matched.length) {
    ...
    if (String(school?.schoolPropertyLabel || '').includes('市重点')) {
      return ['人文综合'];
    }
  }
