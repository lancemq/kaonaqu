...
export function getSchoolCategoryId(school) {
...
export function getSchoolCategorySlug(school) {
  return getSchoolCategory(school)?.slug || 'other';
}

export function getSchoolCategoryDescription(school) {
  return getSchoolCategory(school)?.description || '';
}

export function getSchoolSpecializations(school) {
...
export function getSchoolCanonicalGroup(school) {
  return school?.groupCanonical || school?.group || '';
}

export const SCHOOL_CATEGORY_LIST = SCHOOL_CATEGORIES;
export const SPECIALIZATION_CATEGORY_LIST = SPECIALIZATION_CATEGORIES;

export function findSchoolCategoryBySlug(slug) {
  return getCategoryBySlug(slug);
}

export function findSpecializationBySlug(slug) {
  return getSpecializationBySlug(slug);
}

export function getSchoolsByCategory(schools, categoryId) {
  return schools.filter((s) => getSchoolCategoryId(s) === categoryId);
}

export function getSchoolsBySpecialization(schools, specId) {
  return schools.filter((s) => getSchoolSpecializations(s).includes(specId));
}

export function getSchoolsByCanonicalGroup(schools, groupName) {
  if (!groupName) return [];
  return schools.filter((s) => getSchoolCanonicalGroup(s) === groupName);
}
