    ...
    sections: [
      {
        ...
        title: '初中学段',
        cards: [
          { title: '七年级', status: '暂未上线', description: '内容正在整理中，后续会补充主学科重点、能力任务和衔接建议。' },
          { title: '八年级', status: '已上线', href: '/knowledge/grade-8', description: '当前内容最完整，涵盖主要学科知识点与学习计划，是现阶段主入口。' },
          { title: '九年级', status: '暂未上线', description: '中考复习与综合冲刺内容正在整理中，暂不开放年级详情页。' }
        ]
      },
      {
        id: 'high-school',
        ...
        title: '高中学段',
        cards: [
          { title: '高一', status: '暂未上线', description: '高中学习节奏、学科体系搭建和阶段推进方式正在整理中。' },
          { title: '高二', status: '暂未上线', description: '重难点专题、选科推进和阶段提升内容正在整理中。' },
          { title: '高三', status: '暂未上线', description: '高考复习链路、轮次规划与冲刺建议正在整理中。' }
        ]
      },
      {
        id: 'reading-path',
      ...
      },
      {
        ...
        items: [
          ...
          '当前已上线八年级内容，可优先用于知识衔接、专题整理与后续复习准备。',
          '高中阶段建议按高一基础、高二深化、高三冲刺三段推进。',
          '未上线年级暂不提供跳转入口，可先按学段规划做预习准备。'
        ]
      }
    ]
  },
