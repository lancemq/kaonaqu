  ...
  'grade-9': {
    ...
    sections: [
      ...
      },
      {
        ...
        kicker: '核心公式',
        title: '九年级物理核心公式速查',
        intro: '电学与力学综合常用公式：电功率可写作 $P = UI = I^{2}R = \\frac{U^{2}}{R}$。',
        equations: [
          { tex: 'F = k\\frac{q_{1}q_{2}}{r^{2}}', caption: '库仑定律' },
          { tex: 'P = UI = I^{2}R = \\frac{U^{2}}{R}', caption: '电功率' },
          { tex: 'W = UIt', caption: '电功' },
          { tex: 'I = \\frac{U}{R}', caption: '欧姆定律' }
        ]
      }
    ]
  },
  ...
  'senior-2': {
    ...
    sections: [
      ...
      },
      {
        ...
        kicker: '核心公式',
        title: '高二数学核心公式速查',
        intro: '导数与积分是高二数学的主线，例如二次函数求导可写为 $f\'(x)=2ax+b$，积分则是其逆运算。',
        equations: [
          { tex: '\\frac{d}{dx}\\,x^{n} = n x^{n-1}', caption: '幂函数求导' },
          { tex: '\\int x^{n}\\,dx = \\frac{x^{n+1}}{n+1} + C \\quad (n \\neq -1)', caption: '幂函数积分' },
          { tex: '\\lim_{x \\to 0}\\frac{\\sin x}{x} = 1', caption: '重要极限' },
          { tex: '\\frac{d}{dx}\\left(e^{x}\\right) = e^{x}', caption: '指数函数求导' }
        ]
      }
    ]
  },
