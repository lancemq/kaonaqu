  ...
  index: {
    hero: {
      ...
      stats: [
        ...
        { label: '当前重点', value: '8年级', description: '理化和主学科内容更完整' }
      ]
    },
    leadCards: [
      {
        title: '如何使用知识体系',
        description: '建议先进入对应年级，再从学科页查看知识说明、关键点、易错点、事例、例题和学习计划。需要复习时，可把“章节重点 + 例题 + 错题”作为固定整理方式。'
      },
      {
        title: '当前阅读方式',
        list: [
    ...
    ribbons: [
      ...
      { label: '推荐入口', title: '八年级', description: '理化内容、例题和实验组织相对更完整，适合先查看。' }
    ],
    sections: [
      {
        id: 'junior',
        ...
        title: '初中学段',
        cards: [
          { title: '七年级', status: '已上线', href: '/knowledge/grade-7', description: '建立初中阶段核心学科框架，已整理主学科重点、能力任务和衔接建议。' },
          { title: '八年级', status: '已上线', href: '/knowledge/grade-8', description: '当前内容最完整，涵盖主要学科知识点与学习计划，是现阶段主入口。' },
          { title: '九年级', status: '已上线', href: '/knowledge/grade-9', description: '面向中考复习与综合冲刺，已整理全年复习链路、学科突破点与模考策略。' }
        ]
      },
      {
        id: 'high-school',
        ...
        title: '高中学段',
        cards: [
          { title: '高一', status: '已上线', href: '/knowledge/senior-1', description: '从学科体系搭建和高中学习节奏管理入手，已整理学科重点和阶段推进方式。' },
          { title: '高二', status: '已上线', href: '/knowledge/senior-2', description: '强化重难点专题、选科推进和阶段提升，已补齐核心任务和学科焦点。' },
          { title: '高三', status: '已上线', href: '/knowledge/senior-3', description: '以高考复习链路为核心，已提供轮次规划、学科收口重点与冲刺建议。' }
        ]
      },
      {
        id: 'reading-path',
      ...
      },
      {
        ...
        items: [
          ...
          '初二至初三阶段重在知识衔接、专题整理与中考导向训练。',
          '高中阶段建议按高一基础、高二深化、高三冲刺三段推进。',
          '优先使用已上线内容学习，未上线年级可先按学段规划做预习准备。'
        ]
      }
    ]
  },
